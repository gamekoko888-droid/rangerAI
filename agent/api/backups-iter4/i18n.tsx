...
export type TranslationKeys = {
  ...
  'msg.plan.executing': '任务执行中',
  'msg.plan.completed': '任务完成',
  'msg.plan.toolsUsed': '个工具调用',
  ...
  'msg.action.thumbsUp': '👍 有帮助',
  'msg.action.thumbsDown': '👎 需改进',
  'msg.search.placeholder': '搜索对话内容...',
  'msg.search.noResults': '无匹配',
  'msg.scroll.newMessages': '新消息 ↓',

  // MessageList — Streaming / thinking
  'msg.stream.deepThinking': string;
  'browserPreview.title': string;
  'browserPreview.noScreenshots': string;
  'browserPreview.hint': string;
  'browserPreview.loading': string;
  'browserPreview.takeOver': string;
  'browserPreview.returnControl': string;
  'browserPreview.connecting': string;
  'browserPreview.interactiveMode': string;
  'browserPreview.youHaveControl': string;
  'browserPreview.browserOffline': string;
  'browserPreview.aiMode': string;
  'browserPreview.idle': string;
  ...
  'msg.welcome.quickSearch': '帮我搜索分析竞品信息',
  'msg.welcome.quickData': '生成一份数据分析报告',
  'msg.welcome.quickWrite': '帮我撰写一篇营销文案',
...
const zhCN: TranslationKeys = {
  ...
  'capabilities.searchSkills': '搜索 Skills...',
  'capabilities.searchTools': '搜索 Tools...',
  ...
  'msg.plan.executing': '任務執行中',
  'msg.plan.completed': '任務完成',
  'msg.plan.toolsUsed': '個工具調用',
  // Tool card labels
  'msg.card.params': '参数',
  'msg.card.result': '结果',
  ...
  'msg.action.thumbsUp': '👍 有幫助',
  'msg.action.thumbsDown': '👎 需改進',
  'msg.search.placeholder': '搜尋對話內容...',
  'msg.search.noResults': '無匹配',
  'msg.scroll.newMessages': '新訊息 ↓',

  // Streaming / thinking
  'msg.stream.deepThinking': '深度思考中',
  'browserPreview.title': '浏览器预览',
  'browserPreview.noScreenshots': '暂无浏览器活动',
  'browserPreview.hint': '当 AI 使用浏览器工具时，截图将在此显示',
  'browserPreview.loading': '浏览中...',
  'browserPreview.takeOver': '接管浏览器',
  'browserPreview.returnControl': '交还控制权给 AI',
  'browserPreview.connecting': '连接中...',
  'browserPreview.interactiveMode': '交互模式',
  'browserPreview.youHaveControl': '你正在控制浏览器',
  'browserPreview.browserOffline': '浏览器离线',
  'browserPreview.aiMode': 'AI 模式',
  'browserPreview.idle': '空闲',
  ...
  'msg.welcome.quickSearch': '幫我搜索分析競品資訊',
  'msg.welcome.quickData': '生成一份數據分析報告',
  'msg.welcome.quickWrite': '幫我撰寫一篇行銷文案',
  ...
  'model.geminiProDesc': '多模态推理·美学创意',
...
const zhTW: TranslationKeys = {
  ...
  'capabilities.tools': 'Tools',
  'capabilities.caps': 'Caps',
  'capabilities.searchSkills': '搜尋 Skills...',
  'capabilities.searchTools': '搜尋 Tools...',
  ...
  'msg.plan.executing': 'Task Executing',
  'msg.plan.completed': 'Task Completed',
  'msg.plan.toolsUsed': 'tool calls',
  'msg.card.params': '參數',
  'msg.card.result': '結果',
  ...
  'msg.action.copy': '複製',
  'msg.action.regenerate': '重新生成',
  'msg.action.thumbsUp': '👍 Helpful',
  'msg.action.thumbsDown': '👎 Needs improvement',
  'msg.search.placeholder': 'Search in conversation...',
  'msg.search.noResults': 'No matches',
  'msg.scroll.newMessages': 'New messages ↓',
  'msg.stream.deepThinking': '深度思考中',
  'browserPreview.title': '瀏覽器預覽',
  'browserPreview.noScreenshots': '暫無瀏覽器活動',
  'browserPreview.hint': '當 AI 使用瀏覽器工具時，截圖將在此顯示',
  'browserPreview.loading': '瀏覽中...',
  'browserPreview.takeOver': '接管瀏覽器',
  'browserPreview.returnControl': '交還控制權給 AI',
  'browserPreview.connecting': '連接中...',
  'browserPreview.interactiveMode': '交互模式',
  'browserPreview.youHaveControl': '你正在控制瀏覽器',
  'browserPreview.browserOffline': '瀏覽器離線',
  'browserPreview.aiMode': 'AI 模式',
  'browserPreview.idle': '空閒',
  'msg.stream.thinking': '正在思考...',
  'msg.stream.close': '關閉',
  ...
  'msg.welcome.quickSearch': 'Search and analyze competitor info',
  'msg.welcome.quickData': 'Generate a data analysis report',
  'msg.welcome.quickWrite': 'Write a marketing copy for me',
  ...
  'model.geminiProDesc': '多模態推理·美學創意',
...
const en: TranslationKeys = {
  ...
  'toast.waitForAI': 'Please wait for AI to finish replying',
  ...
  'input.stopGeneration': 'Stop generating',
  ...
  'browserPreview.noScreenshots': 'No browser activity',
  'browserPreview.hint': 'Screenshots will appear here when the AI uses browser tools',
  'browserPreview.loading': 'Browsing...',
  'browserPreview.takeOver': 'Take Over Browser',
  'browserPreview.returnControl': 'Return Control to AI',
  'browserPreview.connecting': 'Connecting...',
  'browserPreview.interactiveMode': 'Interactive Mode',
  'browserPreview.youHaveControl': 'You have control',
  'browserPreview.browserOffline': 'Browser Offline',
  'browserPreview.aiMode': 'AI Mode',
  'browserPreview.idle': 'Idle',
  ...
  'model.geminiProDesc': 'Multimodal reasoning & aesthetics',
