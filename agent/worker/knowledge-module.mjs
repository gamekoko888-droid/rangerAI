...
export class KnowledgeModule {
  ...
  _conflictPenalty(content) { const text = String(content || '').toLowerCase(); const hasPositive = /(always|must|definitely|100%)/.test(text); const hasHedge = /(maybe|might|depends|approximately)/.test(text); return hasPositive && hasHedge ? 5 : 0; }
